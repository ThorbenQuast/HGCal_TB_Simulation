...
options.register('setupConfiguration',
                0,
                 VarParsing.VarParsing.multiplicity.singleton,
                 VarParsing.VarParsing.varType.int,
                 'setupConfiguration (0: March 2018 - test).'
                )
...
process.load('Geometry.HGCalCommonData.hgcalParametersInitializationDESY18_cfi')
...
process.VtxSmeared.MaxZ = 1095.000001
process.VtxSmeared.MinX = -0.01
process.VtxSmeared.MaxX = 0.01
process.VtxSmeared.MinY = -0.01
process.VtxSmeared.MaxY = 0.01
